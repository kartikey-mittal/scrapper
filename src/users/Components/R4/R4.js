...
const R4 = () => {
  const scrapPartnerData = [
   ...
   { imageUrl: 'https://imgs.search.brave.com/NPql5XtZvmAas8vwf4qtraxoKgOm96yzqCvtAUM52fo/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9jZG4u/cGl4YWJheS5jb20v/cGhvdG8vMjAxMi8x/Mi8yNC8wOC8zOC9j/b3BwZXItNzIwNjJf/NjQwLmpwZw',partnerInfo: { name: 'kartikey mittal', material: 'iron',weightPerKg:'10' } },
  ...
  return (
   <div style={ {display:'flex',flexDirection:'column', alignContent:'center' ,height:'100%',padding:'10px'}}>
